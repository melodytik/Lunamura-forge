...
public class LunamuraModsChestHorse extends CraftChestedHorse {

    public LunamuraModsChestHorse(CraftServer server, AbstractChestedHorse entity) {
        super(server, entity);
    }

    @Override
    public String toString() {
        return "LunamuraModsChestHorse{" + getType() + '}';
    }
