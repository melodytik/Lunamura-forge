...
public class LunamuraServerListPingEvent extends org.bukkit.event.server.ServerListPingEvent {

    private final Object[] players;
    public CraftIconCache icon;

    public LunamuraServerListPingEvent(Connection connection, MinecraftServer server) {
