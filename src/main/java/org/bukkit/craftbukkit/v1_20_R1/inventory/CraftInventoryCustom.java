...
public class CraftInventoryCustom extends CraftInventory {
    ...
    public String getTitle() {
        return ((MinecraftInventory) inventory).getTitle(); // Lunamura - We don't have Paper's custom holder here
    }

    public net.kyori.adventure.text.Component title() {
        return ((MinecraftInventory) inventory).title(); // Lunamura - We don't have Paper's custom holder here
    }
    // Paper end
