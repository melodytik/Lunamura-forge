...
import com.mohistmc.bukkit.inventory.LunamuraSpecialIngredient;
...
public interface CraftRecipe extends Recipe {
    ...
    default Ingredient toNMS(RecipeChoice bukkit, boolean requireNotEmpty) {
        ...
        if (bukkit == null) {
            ...
            stack.exact = true;
        }else if (bukkit instanceof LunamuraSpecialIngredient lunamuraSpecialIngredient) {
            stack = lunamuraSpecialIngredient.ingredient();
        } else {
    ...
    public static RecipeChoice toBukkit(Ingredient list) {
        list.getItems();
        if (!list.isVanilla()) {
            return new LunamuraSpecialIngredient(list);
        }
