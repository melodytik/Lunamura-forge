...
public class CraftInventoryView extends InventoryView {
    ...
    public CraftInventoryView(HumanEntity player, Inventory viewing, AbstractContainerMenu container) {
        ...
        if (container.slots.size() > this.countSlots()) {
            this.viewing = new CraftInventory(new LunamuraModsInventory(container, ((CraftHumanEntity) player).getHandle()));
        }
    }
    ...
    public net.kyori.adventure.text.Component title() {
        return com.mohistmc.paper.adventure.PaperAdventure.asAdventure(this.container.getTitle()); // Lunamura - Use Lunamura's PaperAdventure
    }
    // Paper end
