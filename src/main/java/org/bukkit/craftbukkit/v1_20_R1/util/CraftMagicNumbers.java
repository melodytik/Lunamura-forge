...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public byte[] processClass(PluginDescriptionFile pdf, String path, byte[] clazz) {
        ...
        // Lunamura start (CatServer) - plugin bytecode compatibility shims
        clazz = com.mohistmc.bukkit.pluginfix.PluginBytecodeHandler.processPluginClass(pdf.getFullName() + ":" + path, clazz);
        // Lunamura end
