...
import com.mohistmc.bukkit.entity.LunamuraModsMonster;
import com.mohistmc.bukkit.entity.LunamuraModsProjectileEntity;
...
public enum EntityType implements Keyed, Translatable, net.kyori.adventure.translation.Translatable { // Paper - translatable
    ...
    FORGE_MOD_PROJECTILE("forge_mod_projectile", LunamuraModsProjectileEntity.class, -1, false),
    FORGE_MOD_CHEST_HORSE("forge_mod_chest_horse", LunamuraModsChestHorse.class, -1, false),
    FORGE_MOD_MINECART_CONTAINER("forge_mod_minecart_container", LunamuraModsMinecartContainer.class, -1, false),
    FORGE_MOD_HORSE("forge_mod_horse", LunamuraModsAbstractHorse.class, -1, false),
    FORGE_MOD_TAMEABLE_ANIMALS("forge_mod_tameable_animal", LunamuraModsTameableEntity.class, -1, false ),
    FORGE_MOD_ANIMAL("forge_mod_animal", LunamuraModsAnimals.class, -1, false ),
    FORGE_MOD_MONSTER("forge_mod_monster", LunamuraModsMonster.class, -1, false);
    ...
    public String getName() {
        return name == null ? name() : name; // Lunamura
    }
