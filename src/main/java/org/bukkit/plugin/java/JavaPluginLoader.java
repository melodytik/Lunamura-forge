...
public final class JavaPluginLoader implements PluginLoader {
    ...
    public Plugin loadPlugin(@NotNull final File file) throws InvalidPluginException {
        ...
        if (dataFolder.equals(oldDataFolder)) {
            ...
            server.getLogger().warning(String.format(
                LunamuraMC.i18n.as("lunamura.i18n.16",
            ...
            if (!oldDataFolder.renameTo(dataFolder)) {
                throw new InvalidPluginException(LunamuraMC.i18n.as("lunamura.i18n.17", oldDataFolder, dataFolder));
            }
            server.getLogger().log(Level.INFO, String.format(
                LunamuraMC.i18n.as( "lunamura.i18n.18",
                description.getFullName(),
                file,
                oldDataFolder,
                dataFolder
        ...
        if (dataFolder.exists() && !dataFolder.isDirectory()) {
            throw new InvalidPluginException(String.format(
                LunamuraMC.i18n.as("lunamura.i18n.19",
                dataFolder,
                description.getFullName(),
                file
            )));
        ...
        for (final String pluginName : description.getDepend()) {
            ...
            if (current == null) {
                throw new UnknownDependencyException(LunamuraMC.i18n.as("lunamura.i18n.12", pluginName, pluginName));
            }
        }
    ...
    public Map<Class<? extends Event>, Set<RegisteredListener>> createRegisteredListeners(@NotNull Listener listener, @NotNull final Plugin plugin) {
        ...
        try {
            ...
            plugin.getLogger().severe(LunamuraMC.i18n.as("lunamura.i18n.13", plugin.getDescription().getFullName(), listener.getClass(), e.getMessage()));
            return ret;
        }
        ...
        for (final Method method : methods) {
            ...
            if (method.getParameterTypes().length != 1 || !Event.class.isAssignableFrom(checkClass = method.getParameterTypes()[0])) {
                plugin.getLogger().severe(LunamuraMC.i18n.as("lunamura.i18n.14", plugin.getDescription().getFullName(), method.toGenericString(), listener.getClass()));
                continue;
            }
            ...
            for (Class<?> clazz = eventClass; Event.class.isAssignableFrom(clazz); clazz = clazz.getSuperclass()) {
                ...
                if (clazz.getAnnotation(Deprecated.class) != null) {
                    ...
                    plugin.getLogger().log(
                            Level.WARNING,
                            String.format(
                                    LunamuraMC.i18n.as( "lunamura.i18n.15",
    ...
    public void enablePlugin(@NotNull final Plugin plugin) {
        ...
        if (!plugin.isEnabled()) {
            LunamuraMC.LOGGER.info(I18n.as("minecraftserver.plugin.load.enabling", plugin.getDescription().getFullName()));
            ...
            if (!loaders.contains(pluginLoader)) {
                ...
                LunamuraMC.LOGGER.warn(LunamuraMC.i18n.as( "lunamura.i18n.20", plugin.getDescription().getFullName()));
            }
            ...
            try {
                ...
                ex.printStackTrace();
                LunamuraMC.LOGGER.error(LunamuraMC.i18n.as("lunamura.i18n.21", plugin.getDescription().getFullName()), ex);
                // Lunamura start - Disable plugins that fail to load
    ...
    public void disablePlugin(@NotNull Plugin plugin) {
        ...
        if (plugin.isEnabled()) {
            plugin.getLogger().info(LunamuraMC.i18n.as("minecraftserver.plugin.load.disabling",plugin.getDescription().getFullName()));
            ...
            try {
                ...
                server.getLogger().log(Level.SEVERE, LunamuraMC.i18n.as( "lunamura.i18n.22", plugin.getDescription().getFullName()), ex);
            }
