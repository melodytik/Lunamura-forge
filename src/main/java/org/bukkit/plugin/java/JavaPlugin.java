...
import com.mohistmc.forge.LunamuraEventBus;
...
public abstract class JavaPlugin extends PluginBase {
    ...
    public void registerForgeEvent(IEventBus bus, Object target) {
        try {
            if (bus instanceof EventBus eventBus) {
                LunamuraEventBus.register(eventBus, target);
    ...
    public void registerForgeEvent(Object target) {
        try {
            ...
            LunamuraEventBus.register((EventBus) eventBus, target);
    ...
    public void unregisterForgeEvents(IEventBus bus, Object target) {
        // Added so we can unregister the listener and remove it if need be to stop Lunamura from needing to unregister it later
    ...
    public void saveConfig() {
        try {
            ...
            logger.log(Level.SEVERE, LunamuraMC.i18n.as("lunamura.i18n.4",configFile), ex);
        }
    }
    ...
    public void saveResource(@NotNull String resourcePath, boolean replace) {
        ...
        try {
            if (!outFile.exists() || replace) {
                ...
                logger.log(Level.WARNING, LunamuraMC.i18n.as("lunamura.i18n.5", outFile.getName(), outFile,outFile.getName()));
            }
        } catch (IOException ex) {
            logger.log(Level.SEVERE, LunamuraMC.i18n.as("lunamura.i18n.6", outFile.getName(), outFile), ex);
        }
    }
    ...
    public static <T extends JavaPlugin> T getPlugin(@NotNull Class<T> clazz) {
        ...
        if (!JavaPlugin.class.isAssignableFrom(clazz)) {
            throw new IllegalArgumentException(LunamuraMC.i18n.as("lunamura.i18n.7", clazz, JavaPlugin.class));
        }
        final ClassLoader cl = clazz.getClassLoader();
        if (!(cl instanceof PluginClassLoader)) {
            throw new IllegalArgumentException(LunamuraMC.i18n.as("lunamura.i18n.8", clazz,PluginClassLoader.class));
        }
        JavaPlugin plugin = ((PluginClassLoader) cl).plugin;
        if (plugin == null) {
            throw new IllegalStateException(LunamuraMC.i18n.as("lunamura.i18n.9", clazz));
        }
    ...
    public static JavaPlugin getProvidingPlugin(@NotNull Class<?> clazz) {
        ...
        final ClassLoader cl = clazz.getClassLoader();
        if (!(cl instanceof PluginClassLoader)) {
            throw new IllegalArgumentException(LunamuraMC.i18n.as("lunamura.i18n.10", clazz,PluginClassLoader.class));
        }
        JavaPlugin plugin = ((PluginClassLoader) cl).plugin;
        if (plugin == null) {
            throw new IllegalStateException(LunamuraMC.i18n.as("lunamura.i18n.11", clazz));
        }
        return plugin;
    }
}
