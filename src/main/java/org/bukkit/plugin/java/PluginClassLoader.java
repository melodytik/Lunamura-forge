    ...
    PluginClassLoader(@NotNull final JavaPluginLoader loader, @Nullable final ClassLoader parent, @NotNull final PluginDescriptionFile description, @NotNull final File dataFolder, @NotNull final File file, @Nullable ClassLoader libraryLoader) throws IOException, InvalidPluginException, MalformedURLException {
        ...
        try {
            ...
            try {
                ...
                throw new InvalidPluginException(LunamuraMC.i18n.as("lunamura.i18n.26", description.getMain()), ex);
            }
            ...
            try {
                ...
                throw new InvalidPluginException(LunamuraMC.i18n.as("lunamura.i18n.27", description.getMain()), ex);
            }
        ...
        if (PluginHooks.hook(plugin)) {
            ((TransformingClassLoader) LunamuraMC.classLoader).addChild(this);
        }
    }
            ...
            if (result != null) {
                ...
                if (result.getClassLoader() instanceof PluginClassLoader) {
                    ...
                    if (provider != description
                        ...
                        if (plugin != null) {
                            plugin.getLogger().log(Level.WARNING,LunamuraMC.i18n.as("lunamura.i18n.28", name, provider.getFullName()));
                        } else {
                            // In case the bad access occurs on construction
                            loader.server.getLogger().log(Level.WARNING,LunamuraMC.i18n.as("lunamura.i18n.29", description.getName(), name, provider.getFullName()));
                        }
                    }
                }
                ...
                try {
                    ...
                    byteSource = () -> {
                        try (InputStream is = connection.getInputStream()) {
                            ...
                            classBytes = PluginFixManager.injectPluginFix(name, classBytes); // Lunamura - Inject plugin fix
                            return classBytes;
                        }
                    };
                } catch (IOException e) {
                ...
                if (dot != -1) {
                    ...
                    if (getPackage(pkgName) == null) {
                        try {
                            ...
                            if (getPackage(pkgName) == null) {
                                throw new IllegalStateException(LunamuraMC.i18n.as("lunamura.i18n.30", pkgName));
                            }
                        }
                    }
                }
