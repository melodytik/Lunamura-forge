...
public final class PluginDescriptionFile {
    ...
    public List<Permission> getPermissions() {
        if (permissions == null) {
            if (lazyPermissions == null) {
                ...
                permissions = ImmutableList.copyOf(Permission.loadPermissions(lazyPermissions, LunamuraMC.i18n.as("lunamura.i18n.31", getFullName(), defaultPerm), defaultPerm));
    ...
    private void loadMap(@NotNull Map<?, ?> map) throws InvalidDescriptionException {
        try {
            ...
            if (!VALID_NAME.matcher(name).matches()) {
                throw new InvalidDescriptionException(LunamuraMC.i18n.as("lunamura.i18n.32", name))
                        ;
            }
            name = name.replace(' ', '_');
    ...
    private static List<String> makePluginNameList(@NotNull final Map<?, ?> map, @NotNull final String key) throws InvalidDescriptionException {
        ...
        try {
            ...
            throw new InvalidDescriptionException(ex, LunamuraMC.i18n.as("lunamura.i18n.33", key));
        } catch (NullPointerException ex) {
            throw new InvalidDescriptionException(ex, LunamuraMC.i18n.as("lunamura.i18n.34", key));
        }
    ...
    private Map<?, ?> asMap(@NotNull Object object) throws InvalidDescriptionException {
        ...
        throw new InvalidDescriptionException(LunamuraMC.i18n.as("lunamura.i18n.35", object));
    }
