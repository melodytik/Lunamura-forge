    ...
    public static class Deserializer implements JsonDeserializer<Transformation>
    {
        ...
        public Transformation deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
        {
            if (json.isJsonPrimitive() && json.getAsJsonPrimitive().isString())
            {
                ...
                {
                    throw new JsonParseException(LunamuraMC.i18n.as("lunamura.i18n.80", transform));
                }
            }
            if (json.isJsonArray())
            {
            ...
            if (!json.isJsonObject()) throw new JsonParseException(LunamuraMC.i18n.as("lunamura.i18n.81", json));
            ...
            if (!elements.isEmpty()) throw new JsonParseException(LunamuraMC.i18n.as("lunamura.i18n.82", String.join(", ", elements)));
