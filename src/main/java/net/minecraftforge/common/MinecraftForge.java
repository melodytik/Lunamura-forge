...
public class MinecraftForge
{
   ...
   {
       LOGGER.info(FORGE,LunamuraMC.i18n.as("lunamura.i18n.104", ForgeVersion.getVersion()));
       LOGGER.info(FORGE,LunamuraMC.i18n.as("lunamura.i18n.105", LunamuraMC.versionInfo.neoforge()));
