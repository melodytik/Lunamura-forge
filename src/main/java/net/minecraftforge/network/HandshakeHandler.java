...
public class HandshakeHandler
{
    ...
    private HandshakeHandler(Connection networkManager, NetworkDirection side)
    {
        ...
        if (networkManager.isMemoryConnection()) {
            ...
            LOGGER.debug(FMLHSMARKER,LunamuraMC.i18n.as("lunamura.i18n.114", this.messageList.size()));
        }
    }
    ...
    {
        LOGGER.debug(FMLHSMARKER,LunamuraMC.i18n.as("lunamura.i18n.115", String.join(", ", serverModList.getModList())));
    ...
    {
        LOGGER.debug(FMLHSMARKER,LunamuraMC.i18n.as("lunamura.i18n.116", message.getAsInt(), message.getClass().getName()));
        boolean removed = this.sentMessages.removeIf(i-> i == message.getAsInt());
        if (!removed) {
            LOGGER.error(FMLHSMARKER,LunamuraMC.i18n.as("lunamura.i18n.117", message.getAsInt()));
        }
    }

    void handleClientModListOnServer(HandshakeMessages.C2SModListReply clientModList, Supplier<NetworkEvent.Context> c)
    {
        LOGGER.debug(FMLHSMARKER,LunamuraMC.i18n.as("lunamura.i18n.118",  String.join(", ", clientModList.getModList())));
    ...
    void handleRegistryMessage(final HandshakeMessages.S2CRegistry registryPacket, final Supplier<NetworkEvent.Context> contextSupplier){
        LOGGER.debug(FMLHSMARKER,LunamuraMC.i18n.as("lunamura.i18n.119", registryPacket.getRegistryName()));
    ...
    private boolean handleRegistryLoading(final Supplier<NetworkEvent.Context> contextSupplier) {
        ...
        contextSupplier.get().enqueueWork(() -> {
            ...
            if (!missingData.isEmpty()) {
                LOGGER.error(FMLHSMARKER,LunamuraMC.i18n.as("lunamura.i18n.120", LogMessageAdapter.adapt(sb->
    ...
    public boolean tickServer()
    {
        ...
        if (packetPosition < messageList.size()) {
            ...
            LOGGER.debug(FMLHSMARKER,LunamuraMC.i18n.as("lunamura.i18n.121", message.getMessageContext(), message.getChannelName(), packetPosition));
