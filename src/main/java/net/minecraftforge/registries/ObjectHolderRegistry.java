...
public class ObjectHolderRegistry
{
    ...
    public static void findObjectHolders()
    {
        ...
        VANILLA_OBJECT_HOLDERS.forEach(data -> {
            ...
            {
                throw new RuntimeException(LunamuraMC.i18n.as("lunamura.i18n.213"), e);
            }
        });
        ...
        LOGGER.debug(ForgeRegistry.REGISTRIES, LunamuraMC.i18n.as("lunamura.i18n.214", objectHolders.size()));
    }
            ...
            String value, boolean isClass, boolean extractFromValue)
    {
        ...
        else
        {
            if (value.indexOf(':') == -1)
            {
                ...
                if (prefix == null)
                {
                    LOGGER.warn(ForgeRegistry.REGISTRIES, LunamuraMC.i18n.as("lunamura.i18n.215", value, type, annotationTarget));
            ...
            Type targetClass, Object declaration)
    {
        ...
        throw new IllegalStateException(LunamuraMC.i18n.as("lunamura.i18n.216", declaration));
    }
    ...
    public static void applyObjectHolders()
    {
        try
        {
            LOGGER.debug(ForgeRegistry.REGISTRIES, LunamuraMC.i18n.as("lunamura.i18n.217"));
            applyObjectHolders(key -> true);
            LOGGER.debug(ForgeRegistry.REGISTRIES, LunamuraMC.i18n.as("lunamura.i18n.219"));
    ...
    {
        RuntimeException aggregate = new RuntimeException(LunamuraMC.i18n.as("lunamura.i18n.218"));
