...
public final class RegistryObject<T> implements Supplier<T>
{
            ...
            public void accept(Predicate<ResourceLocation> pred)
            {
                ...
                if (!RegistryObject.this.optionalRegistry && !registryExists)
                {
                    if (!registryExists(registryName))
                    {
                        ...
                        throw new IllegalStateException(LunamuraMC.i18n.as("lunamura.i18n.222", registryName, modid, callerStack));
                    }
                    registryExists = true;
                }
    ...
    {
        T ret = this.value;
        if (ret == null) throw new NullPointerException(LunamuraMC.i18n.as("lunamura.i18n.223", this.name));
        return ret;
    }
