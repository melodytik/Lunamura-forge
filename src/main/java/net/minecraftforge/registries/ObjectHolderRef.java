...
class ObjectHolderRef implements Consumer<Predicate<ResourceLocation>>
{
    ...
    static ObjectHolderRef create(ResourceLocation registryName, Field field, String injectedObject, boolean extractFromExistingValues)
    {
        ...
        else
        {
            ...
            {
                throw new IllegalArgumentException(LunamuraMC.i18n.as("lunamura.i18n.208", field.toString()), e);
            }
        }

        if (injectedObjectName == null)
            throw new IllegalStateException(String.format(Locale.ENGLISH, LunamuraMC.i18n.as("lunamura.i18n.209", field.getType().getName(), field.getDeclaringClass().getName(), field.getName())));

        field.setAccessible(true);

        if (Modifier.isFinal(field.getModifiers()))
        {
            throw new RuntimeException(LunamuraMC.i18n.as("lunamura.i18n.210", field.getDeclaringClass().getName(), field.getName()));
        }
    ...
    public void accept(Predicate<ResourceLocation> filter)
    {
        ...
        if (thing == null)
        {
            LOGGER.debug(LunamuraMC.i18n.as("lunamura.i18n.211", injectedObject, field));
            return;
        }
        try
        {
        ...
        {
            LOGGER.warn(LunamuraMC.i18n.as("lunamura.i18n.212", this.field, thing, this.injectedObject), e);
        }
    }
